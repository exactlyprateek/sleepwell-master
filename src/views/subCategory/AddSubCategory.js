...
const AddSubCategory = () => {
    ...
    const onHandlerSubmit = (value) => {
        ...
        formData.append('title', value.subCategory);
        ...
        axios.post('http://markbran.in/apis/admin/subcategory', formData, {
            headers: {
                    ...
                    <CCard>
                        ...
                        <CCardBody>
                            <CForm onSubmit={handleSubmit(onHandlerSubmit)}>
                                    ...
                                    <CCol xs="6">
                                        <CFormGroup>
                                            ...
                                            <CInputGroup className="mb-3">
                                                <CSelect custom name="categoryId" onChange={onChangeCateId} id="categoryId">
                                                        <option value="">
                                                            Select Category
                                                        </option>
                                                    {categories.map(item =>
                                ...
                                <CRow>
                                    <CCol xs="8">
                                        <button className="btn btn-success" disabled={loading ? true : false} type="submit">{loading ? 'Loading...' : 'Add Sub Category'}</button>
                                    </CCol>
                                </CRow>
                            </CForm>
                        </CCardBody>
