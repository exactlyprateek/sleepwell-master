                ...
                <CCol xs="12" sm="12">
                    <CForm encType="multipart/form-data" onSubmit={onHandlerSubmit}>
                        ...
                        <CRow>
                            ...
                            <CCol xl="6">
                                <CFormGroup>
                                    <CLabel htmlFor="shortItem">Phone No.</CLabel>
                                    <CInputGroup className="mb-3">
                                        <CInput type="text" onChange={sectionTwoPhoneNumberOnChange} value={sectionTwoPhoneNumber} placeholder="Phone number" autoComplete="Phone number" />
                                    </CInputGroup>
                                </CFormGroup>
                            </CCol>
                        </CRow>
