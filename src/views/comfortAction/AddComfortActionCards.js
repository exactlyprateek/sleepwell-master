...
const AddComfortActionCards = () => {
	...
	const onHandlerSubmit = () => {
		...
		axios
			.post('http://markbran.in/apis/admin/comfort/action-card', formData, {
				headers: {
	...
	return (
		<CRow>
			<CCol xs="12" sm="12">
				<CCard>
					<CCardHeader>Add Comfort action card</CCardHeader>
					<CCardBody>
						<div>
							<br />
							{alert ? (
...
export default AddComfortActionCards;
