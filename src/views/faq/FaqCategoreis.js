...
const FaqCategories = () => {
    ...
    //* call delete api
    const deleteSize = (faqCateId) => {
        axios.delete(`http://markbran.in/apis/admin/faqCategory/${faqCateId}`, {
            headers: {
        ...
        <CRow>
            <CCol xl={12}>
                <CCard>
                    <CCardHeader>
                        FAQ Category
                        <CLink style={{ float: 'right' }} className="btn btn-success" to="/faq-categories/add">
                            Add FAQ Category
                        </CLink>
                    </CCardHeader>
                    <CCardBody>
                            ...
                            <tbody>
                                {categories.map((item, index) =>
                                    <tr key={item.id}>
                                        ...
                                        <td>
                                            <CLink className="btn btn-sm btn-outline-warning" to={`/faq-categories/edit/${item.id}`}>
                                                Edit
                                            </CLink>
