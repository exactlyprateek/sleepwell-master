                        ...
                        <CCardBody>
                            <CForm onSubmit={handleSubmit(onHandlerSubmit)}>
                                ...
                                <CRow>
                                    ...
                                    <CCol xs="6">
                                        <CFormGroup>
                                            <CLabel htmlFor="category">Select products</CLabel>
                                            <CInputGroup className="mb-3">
                                                <Multiselect
                                                    options={productArray} // Options to display in the dropdown
                                                    // selectedValues={this.state.selectedValue} // Preselected value to persist in dropdown
                                                    onSelect={productsOnSelect} // Function will trigger on select event
                                ...
                                <CRow>
                                    <CCol xs="8">
                                        <button className="btn btn-success" disabled={loading ? true : false} type="submit">{loading ? 'Loading...' : 'Add gift bundle'}</button>
                                    </CCol>
                                </CRow>
                            </CForm>
                        </CCardBody>
